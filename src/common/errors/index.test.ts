...
describe('Custom Error Classes', () => {
	...
	describe('WorkerDoubleInitError', () => {
		...
		it('should handle multiline error messages', () => {
			const multilineMessage = 'Worker initialization failed:\n- Port already in use\n- Cannot start twice'
	...
	describe('AbsentPortDisconnectionError', () => {
		...
		it('should handle null and undefined messages gracefully', () => {
			...
			const errorWithNull = new AbsentPortDisconnectionError(null as any)
			const errorWithUndefined = new AbsentPortDisconnectionError(undefined as any)
	...
	describe('Error inheritance and polymorphism', () => {
		...
		it('should work with error filtering by type', () => {
			...
			const customErrors = errors.filter(error => 
	...
	describe('Error toString and display behavior', () => {
		...
		it('should work with console.log-like operations', () => {
			...
			// This tests that the error can be converted to string without issues
