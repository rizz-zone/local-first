...
describe('WorkerLocalFirst', () => {
	...
	describe('error handling', () => {
		...
		it('should handle undefined or null init parameters', () => {
			...
			localFirst.init(null as unknown as { wsUrl?: string; dbName?: string })
			expect(mockSend).toHaveBeenCalledWith({
				type: 'init',
				wsUrl: undefined,
				dbName: undefined
	...
	describe('init parameter validation', () => {
		it('should handle partial init parameters', () => {
			...
			localFirst.init({ wsUrl: SOCKET_URL })
			expect(mockSend).toHaveBeenCalledWith({
				type: 'init',
				wsUrl: SOCKET_URL,
				dbName: undefined
			...
			localFirst.init({ dbName: DB_NAME })
			expect(mockSend).toHaveBeenCalledWith({
				type: 'init',
				wsUrl: undefined,
				dbName: DB_NAME
		...
		it('should handle extra parameters in init', () => {
			...
			} as unknown as { wsUrl?: string; dbName?: string })
